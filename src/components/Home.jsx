  ...
  <div className="relative max-w-7xl w-full grid grid-cols-1 xl:grid-cols-2 gap-12 items-center">
    ...
    <div className="space-y-8 text-center xl:text-left order-2 xl:order-1">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center xl:justify-start pt-4">
        <button className="px-7 py-3 bg-yellow-400 text-gray-900 font-semibold rounded-xl shadow-md hover:shadow-lg hover:bg-yellow-300 transition-all duration-300 transform hover:scale-105">
          View My Work
        </button>

        <button className="px-7 py-3 border-2 border-white text-white font-semibold rounded-xl hover:bg-white hover:text-gray-900 transition-all duration-300">
          Download Resume
        </button>
      </div>
...
>
  <div className="max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
      ...
      {[
        {
          ...
          image: "/images/1.jpg",
          desc: "A full-stack e-commerce solution with React, Node.js, and MongoDB featuring authentication, payments, and admin dashboard.",
      ...
      {/* Contact Section */}
      <section id="contact" className="py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center mb-8 sm:mb-12 lg:mb-16">Get In Touch</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
            {/* Contact Info */}
            <div className="space-y-6 lg:space-y-8">
              <p className="text-lg lg:text-xl text-gray-300 leading-relaxed text-center lg:text-left">
                I'm always interested in new opportunities and exciting projects. 
                Let's talk about how we can work together!
              </p>
              <div className="space-y-4 lg:space-y-6">
                {[
                  { icon: '📧', text: 'your.email@example.com', href: 'mailto:your.email@example.com' },
                  ...
                  <a 
                    key={index}
                    href={item.href}
                    className="flex items-center space-x-3 sm:space-x-4 text-gray-300 hover:text-white transition-colors duration-200 text-base sm:text-lg lg:text-xl justify-center lg:justify-start"
                  >
            ...
            <form className="space-y-6 sm:space-y-8">
              <div>
                <input 
                  ...
                  className="w-full px-4 sm:px-6 py-3 sm:py-4 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-blue-500 text-white placeholder-gray-400 transition-colors duration-200 text-base sm:text-lg"
                  required
                />
              </div>
              <div>
              ...
              <div>
                <textarea 
                  ...
                  rows="5"
                  className="w-full px-4 sm:px-6 py-3 sm:py-4 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:border-blue-500 text-white placeholder-gray-400 transition-colors duration-200 text-base sm:text-lg resize-none"
                  required
                ></textarea>
              </div>
              <button 
